...
data_file = "D://PycharmProjects//Python_R-Tree-master//20points.txt"
queries_file = "D://PycharmProjects//Python_R-Tree-master//queries.txt"
...
if __name__ == "__main__":
    query_pint = Point(0, 3, 3)
    interest_points = [Point(1, 1, 1), Point(2, 5, 5), Point(3, 5, 1), Point(4, 5, 6), Point(5, 6, 8)]
    bound = 10
    k = 2
    object = Point(4, 6, 1)
    R_tree = construct_r_tree(interest_points)

    print(len(R_tree.root.child_nodes))

    # R_tree.delete_point(Point(10,3317,8484))
    #
    # print(sys.argv)
    # main([sys.argv,data_file,queries_file])
    # data_filename = data_file
    # queries_filename =queries_file
    #
    # # Read data file
    # data_file = open(data_filename, "r")
    # input = data_file.read().split('\n')
    ...
    # R_tree.delete_point(Point(10,3317,8484))
    #
    # points=[Point(10,3317,8484)]
    # if Point(10,3317,8484) in points:
    #     print("yes")
    # print(points[0])
    # Read queries file
    # queries_file = open(queries_filename, "r")
